...
const SafariMobile = () => {
	return (
		<>
			...
			<div className="blog">
				...
				<ul className="flex flex-col gap-4 mb-8">
					{blogPosts.map(({ id, date, title, image, link }) => (
						<li key={id} className="flex flex-row gap-4 items-center">
			...
			<footer className="absolute bottom-0 left-0 right-0 flex flex-col items-center justify-center p-4 border-t border-gray-200 bg-gray-50">
